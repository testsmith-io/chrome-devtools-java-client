...
import com.github.testsmith.cdt.launch.ChromeLauncher.Environment;
import com.github.testsmith.cdt.launch.ChromeLauncher.ShutdownHookRegistry;
...
public class ChromeLauncherTest extends EasyMockSupport {
  ...
  public void testLaunchWithDebugLogging()
    ...
    registerAppenderOnDebugLogger(
        "com.github.testsmith.cdt.launch.chrome.output", Level.DEBUG, loggingEvents);
  ...
  public void testLaunchWithErrorLoggingDoesNotLogAnything()
    ...
    List<String> loggingEvents = new ArrayList<>();
    registerAppenderOnDebugLogger(
        "com.github.testsmith.cdt.launch.chrome.output", Level.ERROR, loggingEvents);
