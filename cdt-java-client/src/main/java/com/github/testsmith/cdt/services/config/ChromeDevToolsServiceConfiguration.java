package com.github.testsmith.cdt.services.config;
...
import com.github.testsmith.cdt.services.executors.DefaultEventExecutorService;
import com.github.testsmith.cdt.services.executors.EventExecutorService;
import com.github.testsmith.cdt.services.utils.ConfigurationUtils;
...
public class ChromeDevToolsServiceConfiguration {
  private static final String READ_TIMEOUT_PROPERTY =
      "com.github.testsmith.cdt.services.config.readTimeout";
   ...
   *
   * <p>This property can be set by {@link
   * com.github.testsmith.cdt.services.config.ChromeDevToolsServiceConfiguration#READ_TIMEOUT_PROPERTY}
   * property.
   *
