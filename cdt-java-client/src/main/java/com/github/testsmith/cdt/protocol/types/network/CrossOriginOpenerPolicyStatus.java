...
/**
 * CrossOriginOpenerPolicyStatus class.
 *
 * @author roy
 * @version $Id: $Id
 */
...
public class CrossOriginOpenerPolicyStatus {
   ...
   *
   * @return a {@link com.github.testsmith.cdt.protocol.types.network.CrossOriginOpenerPolicyValue}
   *     object
   */
   ...
   *
   * @param value a {@link
   *     com.github.testsmith.cdt.protocol.types.network.CrossOriginOpenerPolicyValue} object
   */
  ...
  /**
   * Getter for the field <code>reportOnlyValue</code>.
   *
   * @return a {@link com.github.testsmith.cdt.protocol.types.network.CrossOriginOpenerPolicyValue}
   *     object
   */
  ...
  /**
   * Setter for the field <code>reportOnlyValue</code>.
   *
   * @param reportOnlyValue a {@link
   *     com.github.testsmith.cdt.protocol.types.network.CrossOriginOpenerPolicyValue} object
   */
  ...
  /**
   * Getter for the field <code>reportingEndpoint</code>.
   *
  ...
  /**
   * Setter for the field <code>reportingEndpoint</code>.
   *
   * @param reportingEndpoint a {@link java.lang.String} object
   */
  ...
  /**
   * Getter for the field <code>reportOnlyReportingEndpoint</code>.
   *
   * @return a {@link java.lang.String} object
   */
  ...
  /**
   * Setter for the field <code>reportOnlyReportingEndpoint</code>.
   *
   * @param reportOnlyReportingEndpoint a {@link java.lang.String} object
   */
