...
public class DownloadProgress {
   ...
   * Total expected bytes to download.
   *
   * @param totalBytes a {@link java.lang.Double} object
   */
   ...
   * Total bytes received.
   *
   * @param receivedBytes a {@link java.lang.Double} object
   */
   ...
   * Download status.
   *
   * @return a {@link com.github.testsmith.cdt.protocol.events.browser.DownloadProgressState} object
   */
   ...
   * Download status.
   *
   * @param state a {@link com.github.testsmith.cdt.protocol.events.browser.DownloadProgressState}
   *     object
   */
