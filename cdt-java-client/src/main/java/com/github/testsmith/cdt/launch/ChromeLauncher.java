package com.github.testsmith.cdt.launch;
...
import static com.github.testsmith.cdt.utils.ChromeDevToolsUtils.closeQuietly;
import static com.github.testsmith.cdt.utils.FilesUtils.deleteQuietly;
import static com.github.testsmith.cdt.utils.FilesUtils.randomTempDir;

import com.github.testsmith.cdt.launch.config.ChromeLauncherConfiguration;
import com.github.testsmith.cdt.launch.exceptions.ChromeProcessException;
import com.github.testsmith.cdt.launch.exceptions.ChromeProcessTimeoutException;
import com.github.testsmith.cdt.launch.support.ProcessLauncher;
import com.github.testsmith.cdt.launch.support.annotations.ChromeArgument;
import com.github.testsmith.cdt.launch.support.impl.ProcessLauncherImpl;
import com.github.testsmith.cdt.services.ChromeService;
import com.github.testsmith.cdt.services.impl.ChromeServiceImpl;
...
public class ChromeLauncher implements AutoCloseable {
  ...
  private final Thread shutdownHookThread = new Thread(this::close);
  ...
  private final ChromeLauncherConfiguration configuration;
   ...
   * @param configuration a {@link
   *     com.github.testsmith.cdt.launch.config.ChromeLauncherConfiguration} object
   */
  public ChromeLauncher(
   ...
   * @throws java.lang.IllegalStateException If chrome process has already been started.
   * @throws com.github.testsmith.cdt.launch.exceptions.ChromeProcessException If an I/O error
   *     occurs during chrome process start.
   */
  ...
  /**
   * Returns an exit value. This is just proxy to {@link java.lang.Process#exitValue}.
   *
  ...
  /**
   * Tests whether the subprocess is alive. This is just proxy to {@link
   * java.lang.Process#isAlive()}.
   *
   * @return True if the subprocess has not yet terminated.
   * @throws java.lang.IllegalThreadStateException if the subprocess has not yet terminated.
   */
