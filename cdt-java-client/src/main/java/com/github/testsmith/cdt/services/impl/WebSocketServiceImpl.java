...
import static com.github.testsmith.cdt.services.impl.utils.WebSocketUtils.isTyrusBufferOverflowCloseReason;
...
import com.github.testsmith.cdt.services.factory.impl.DefaultWebSocketContainerFactory;
...
public class WebSocketServiceImpl implements WebSocketService {
  /**
   * Constant <code>
   * WEB_SOCKET_CONTAINER_FACTORY_PROPERTY="com.github.testsmith.cdt.services.confi"{trunked}</code>
   */
  public static final String WEB_SOCKET_CONTAINER_FACTORY_PROPERTY =
      "com.github.testsmith.cdt.services.config.webSocketContainerFactory";
   ...
   * @throws com.github.testsmith.cdt.services.exceptions.WebSocketServiceException If it fails to
   *     connect.
   */
   ...
   * com.github.testsmith.cdt.services.config.webSocketContainerProvider. The default value for this
    ...
    try {
      ...
      throw new RuntimeException(
          containerFactoryClassName
              + " does not implement com.github.testsmith.cdt.services.factory.WebSocketContainerFactory interface.");
