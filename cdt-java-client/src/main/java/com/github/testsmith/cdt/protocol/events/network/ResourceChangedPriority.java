...
import com.github.testsmith.cdt.protocol.types.network.ResourcePriority;
...
public class ResourceChangedPriority {
   ...
   * New priority
   *
   * @param newPriority a {@link com.github.testsmith.cdt.protocol.types.network.ResourcePriority}
   *     object
   */
