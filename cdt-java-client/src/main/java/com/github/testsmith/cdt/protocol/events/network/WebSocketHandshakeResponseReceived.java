...
import com.github.testsmith.cdt.protocol.types.network.WebSocketResponse;
...
public class WebSocketHandshakeResponseReceived {
   ...
   *
   * @return a {@link com.github.testsmith.cdt.protocol.types.network.WebSocketResponse} object
   */
   ...
   * WebSocket response data.
   *
   * @param response a {@link com.github.testsmith.cdt.protocol.types.network.WebSocketResponse}
   *     object
   */
