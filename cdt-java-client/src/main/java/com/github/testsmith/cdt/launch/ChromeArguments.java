...
public class ChromeArguments {
  /** Constant <code>USER_DATA_DIR_ARGUMENT="user-data-dir"</code> */
   ...
   * @return Builder. builder
   * @throws java.lang.RuntimeException If it fails to create temp directory for user-data-dir.
   */
  ...
  public static class Builder {
    private final ChromeArguments arguments;
