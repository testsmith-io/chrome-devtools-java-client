...
public class BackgroundColors {
   ...
   * (as if the image had failed to load).
   *
   * @param backgroundColors a {@link java.util.List} object
   */
   ...
   * The computed font size for this node, as a CSS computed value string (e.g. '12px').
   *
   * @param computedFontSize a {@link java.lang.String} object
   */
   ...
   * '100').
   *
   * @param computedFontWeight a {@link java.lang.String} object
   */
