...
import com.github.testsmith.cdt.protocol.types.debugger.DebugSymbols;
...
public class ScriptParsed {
   ...
   * True, if this script is generated as a result of the live edit operation.
   *
   * @param isLiveEdit a {@link java.lang.Boolean} object
   */
   ...
   *
   * @return a {@link com.github.testsmith.cdt.protocol.types.debugger.DebugSymbols} object
   */
   ...
   * If the scriptLanguage is WebASsembly, the source of debug symbols for the module.
   *
   * @param debugSymbols a {@link com.github.testsmith.cdt.protocol.types.debugger.DebugSymbols}
   *     object
   */
