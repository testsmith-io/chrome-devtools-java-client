...
import com.github.testsmith.cdt.launch.ChromeArguments;
...
/**
 * By setting logger `com.github.testsmith.cdt.launch.chrome.output` to DEBUG level, either
 ...
 *
 * <p>Logger `com.github.testsmith.cdt.launch.chrome.output` can be set to DEBUG level
 * programmatically as in an example below (enableDebugChromeOutput method) or by introducing
 *
 * <pre>
 *   <logger name="com.github.testsmith.cdt.launch.chrome.output" level="DEBUG" />
 * </pre>
 *
...
public class ChromeLoggingExample {
  ...
  /**
   * Programmatically set `com.github.testsmith.cdt.launch.chrome.output` to DEBUG level so chrome
   * output can be observed.
   */
  private static void enableDebugChromeOutput() {
    LoggerContext loggerContext = (LoggerContext) LoggerFactory.getILoggerFactory();
    loggerContext.getLogger("com.github.testsmith.cdt.launch.chrome.output").setLevel(Level.DEBUG);
  }
