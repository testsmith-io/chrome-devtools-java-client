package com.github.testsmith.cdt.definition.builder.support.java.builder.impl;
...
import static com.github.testsmith.cdt.definition.builder.support.java.builder.impl.JavaInterfaceBuilderImpl.getClassList;
import static com.github.testsmith.cdt.definition.builder.support.java.builder.impl.JavaInterfaceBuilderImpl.isClassList;
...
public class JavaInterfaceBuilderImplTest extends EasyMockSupport {
  ...
  private static final String BASE_PACKAGE_NAME = "com.github.testsmith";
  private static final String ANNOTATIONS_PACKAGE_NAME = "com.github.testsmith.annotations";
  ...
  public void testBasicInterfaceWithAnnotation() throws IOException {
    ...
    assertEquals(
        "package com.github.testsmith;\n"
            + "\n"
            + "import com.github.testsmith.annotations.Annotation;\n"
            + "\n"
            + "@Annotation\n"
            + "@Deprecated\n"
            + "public interface InterfaceTest {\n"
  ...
  public void testBasicInterfaceWithSimpleMethod2() throws IOException {
    ...
    assertEquals(
        "package com.github.testsmith;\n"
            + "\n"
            + "import com.github.testsmith.annotations.Annotation;\n"
            + "import com.github.testsmith.annotations.Annotation1;\n"
            + "import com.github.testsmith.annotations.ParamValue;\n"
            + "import com.github.testsmith.annotations.Annotation2;\n"
            + "import com.github.testsmith.annotations.Annotation3;\n"
            + "import com.github.testsmith.annotations.Annotation4;\n"
            + "import com.github.testsmith.annotations.Annotation5;\n"
            + "\n"
            + "public interface InterfaceTest {\n"
            + "\n"
            + "    @Annotation\n"
