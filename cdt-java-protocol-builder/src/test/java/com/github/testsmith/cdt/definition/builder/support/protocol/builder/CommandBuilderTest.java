...
import static com.github.testsmith.cdt.definition.builder.support.protocol.builder.CommandBuilder.buildReturnClasses;
import static org.easymock.EasyMock.*;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

import com.github.testsmith.cdt.definition.builder.support.java.builder.*;
import com.github.testsmith.cdt.definition.builder.support.java.builder.support.CombinedBuilders;
import com.github.testsmith.cdt.definition.builder.support.java.builder.support.MethodParam;
import com.github.testsmith.cdt.definition.builder.support.protocol.builder.support.DomainTypeResolver;
import com.github.testsmith.cdt.protocol.definition.types.Command;
import com.github.testsmith.cdt.protocol.definition.types.Domain;
import com.github.testsmith.cdt.protocol.definition.types.Event;
...
import com.github.testsmith.cdt.protocol.definition.types.type.array.items.StringArrayItem;
...
import com.github.testsmith.cdt.protocol.definition.types.type.object.properties.*;
...
public class CommandBuilderTest extends EasyMockSupport {
  ...
  private static final String BASE_PACKAGE_NAME = "com.github.testsmith.test";
  private static final String TYPE_PACKAGE_NAME = "com.github.testsmith.types";
  private static final String EVENTS_PACKAGE_NAME = "com.github.testsmith.events";
  private static final String SUPPORT_TYPES_PACKAGE_NAME = "com.github.testsmith.support.types";
  ...
  public void testBuildCommandWithMethodWithComplexParams()
    ...
    expect(
            javaBuilderFactory.createEnumBuilder(
                "com.github.testsmith.types.domainname", "EnumParam1"))
    ...
    interfaceBuilder.addImport("com.github.testsmith.types.domainname", "TestRef");
    expectLastCall().times(2);
    interfaceBuilder.addImport("java.util", "List");
    interfaceBuilder.addImport("com.github.testsmith.types.domainname", "EnumParam1");
  ...
  public void testBuildCommandWithMethodWithArrayRefParam() {
    ...
    final com.github.testsmith.cdt.protocol.definition.types.type.array.items.RefArrayItem
        refArrayItem =
            new com.github.testsmith.cdt.protocol.definition.types.type.array.items.RefArrayItem();
  ...
  public void testBuildCommandWithMethodWithDeepArrayRefParam() {
    ...
    interfaceBuilder.addImport("com.github.testsmith.types.someotherdomain", "TestRefArrayItem2");
  ...
  public void testBuildCommandWithMethodWithComplexReturnParams() {
    ...
    interfaceBuilder.addImport("com.github.testsmith.types.domainname", "CommandSomeResult");
  ...
  public void testBuildCommandWithMethodWithStringTypedReturnParams() {
    ...
    arrayStringProperty.setItems(
        new com.github.testsmith.cdt.protocol.definition.types.type.object.properties.array.items
            .StringArrayItem());
  ...
  public void testBuildCommandWithMethodWithRefTypedReturnParams() {
    ...
    interfaceBuilder.addImport("java.util", "List");
    interfaceBuilder.addImport("com.github.testsmith.types.domainname", "Metrics");
  ...
  public void testBuildCommandWithMethodWithEnumTypedReturnParams() {
    ...
    expect(
            javaBuilderFactory.createEnumBuilder(
                "com.github.testsmith.types.domainname", "EnumListProperty"))
        .andReturn(javaEnumBuilder);
    ...
    interfaceBuilder.addImport("java.util", "List");
    interfaceBuilder.addImport("com.github.testsmith.types.domainname", "EnumListProperty");
  ...
  public void testBuildCommandWithEvents() {
    ...
    interfaceBuilder.addImport("com.github.testsmith.support.types", "EventListener");
    interfaceBuilder.addImport("com.github.testsmith.support.types", "EventHandler");
    interfaceBuilder.addImport("com.github.testsmith.events.domainname", "SomeEvent");

    interfaceBuilder.addImport("com.github.testsmith.support.types", "EventListener");
    interfaceBuilder.addImport("com.github.testsmith.support.types", "EventHandler");
    interfaceBuilder.addImport("com.github.testsmith.events.domainname", "SomeEvent1");
