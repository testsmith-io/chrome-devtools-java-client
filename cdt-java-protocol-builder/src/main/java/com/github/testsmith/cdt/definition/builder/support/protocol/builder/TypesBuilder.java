...
import static com.github.testsmith.cdt.definition.builder.support.utils.StringUtils.*;
...
import com.github.testsmith.cdt.definition.builder.support.protocol.builder.support.PropertyHandlerResult;
import com.github.testsmith.cdt.definition.builder.support.protocol.builder.support.TypeBuildRequest;
...
import com.github.testsmith.cdt.protocol.definition.types.type.object.properties.array.items.*;
import java.util.*;
...
public class TypesBuilder {
  ...
  static {
    registerTypeArrayItem(
        com.github.testsmith.cdt.protocol.definition.types.type.array.items.StringArrayItem.class,
        "String");
    registerTypeArrayItem(
        com.github.testsmith.cdt.protocol.definition.types.type.array.items.NumberArrayItem.class,
        "Double");
    registerTypeArrayItem(
        com.github.testsmith.cdt.protocol.definition.types.type.array.items.IntegerArrayItem.class,
        "Integer");
  }
  ...
  protected String addRefImportStatement(
    ...
    if (isArrayType(type)) {
      ...
      if (isRefArrayItemType(arrayType.getItems())) {
        com.github.testsmith.cdt.protocol.definition.types.type.array.items.RefArrayItem
            refArrayItem =
                (com.github.testsmith.cdt.protocol.definition.types.type.array.items.RefArrayItem)
                    arrayType.getItems();
  ...
  protected static boolean isRefArrayItemType(
      com.github.testsmith.cdt.protocol.definition.types.type.array.ArrayItem arrayItem) {
    return arrayItem
        instanceof com.github.testsmith.cdt.protocol.definition.types.type.array.items.RefArrayItem;
  }
   ...
   * @param <T> Array item class type.
   */
  private static <T extends com.github.testsmith.cdt.protocol.definition.types.type.array.ArrayItem>
